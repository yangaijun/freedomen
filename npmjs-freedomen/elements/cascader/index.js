...
function FCascader(props) {
    ...
    return (0, react_1.useMemo)(function () {
        return react_1.default.createElement(antd_1.Cascader, __assign({ style: style, className: className, options: options, disabled: disabled, value: item.value, onChange: onChange, placeholder: item.placeholder, dropdownRender: dropdownRender }, config));
