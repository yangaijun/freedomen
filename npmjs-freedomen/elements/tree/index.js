...
function FTree(props) {
    ...
    return (0, react_1.useMemo)(function () {
        return react_1.default.createElement(antd_1.Tree, __assign({ style: style, className: className, fieldNames: { title: 'label', key: 'value' }, dropdownRender: dropdownRender, disabled: disabled, treeData: options }, rst, config));
